...
console.log(
  `calcularPorcentagem1: ${iterations} iterations took ${(Number(end - start) / 1000000).toFixed(2)} ms`,
)
...
console.log(
  `calcularAumentoDesconto: ${iterations} iterations took ${(Number(end - start) / 1000000).toFixed(2)} ms`,
)
...
console.log(
  `calcularProporcaoPorcentual: ${iterations} iterations took ${(Number(end - start) / 1000000).toFixed(2)} ms`,
)
