...
function setupEventListeners() {
  ...
  salarioInput.addEventListener("input", function (e) {
    window.SimulacaoFinanceiraUtils.applyMoneyMask(e.target);
  });
...
function validateBasicInputs() {
  const salario = window.SimulacaoFinanceiraUtils.parseCurrency(
...
function collectFormData() {
  return {
    salario: window.SimulacaoFinanceiraUtils.parseCurrency(
      document.getElementById("salario").value,
    ),
    ...
    saldoFGTS:
      window.SimulacaoFinanceiraUtils.parseCurrency(
